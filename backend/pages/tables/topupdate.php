...
if(isset($_POST['btn']))
{
  ...
  if(move_uploaded_file($filetemnm,$filestore))
    ...
    $update="update details set name='$name',description='$description',duration='$duration',fees='$fees',location='$location',image='$filename where id=$id";
				  ...
				  ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="your_summernote" placeholder="" name="description" value="<?php echo $rw[2];?>"></textarea>
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername1">Duration</label>
                        <input type="text" class="form-control" id="exampleInputDuration1" placeholder="Duration" name="duration" value="<?php echo $rw[3];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername1">Fees</label>
                        <input type="number" class="form-control" id="exampleInputFees1" placeholder="Fees" name="fees" value="<?php echo $rw[4];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername1">Location</label>
                        <input type="text" class="form-control" id="exampleInputDuration1" placeholder="Duration" name="location" value="<?php echo $rw[5];?>">
                      </div>
					  <div class="form-group">

...
if(isset($_POST['btn']))
{
  ...
  if(move_uploaded_file($filetemnm,$filename))
	{
    $update="update teacher set name='$name',post='$post',image='$filename' where id=$id";
				  ...
				  ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Post" name="post" value="<?php echo $rw[2];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputPassword1">Image</label>
                        <input type="file" class="form-control" id="exampleInputPassword1" placeholder="" name="image" value="<?php echo $rw[3];?>">
                      </div>
                     <!-- <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-gradient-primary me-2" name="btn" value="update">Update</button>

...
if(isset($_POST['btn']))
{
   ...
   if(move_uploaded_file($filetemnm,$filename))
	{
    $update="update register set name='$name',email='$email',contact='$contact',pass='$pass',cpass='$cpass',cname='$cname',gender='$gender',image='$filename' where id=$id";
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
			 ...
			 <li class="nav-item">
              <a class="nav-link" href="../../pages/forms/update.php">
                <span class="menu-title">Course Update</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>
            </li>
            <!--<li class="nav-item">
            ...
            <div class="row">
              <div class="col-md-10 grid-margin stretch-card">
                <div class="card">
				  ...
				  ?>
                    <h4 class="card-title">Student Registration Update form</h4>

                    <p class="card-description"></p>
                    <form method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputUsername1">name</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Name" name="name" value="<?php echo $rw[1];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername2">email</label>
                        <input type="email" class="form-control" id="exampleInputUsername2" placeholder="email" name="email" value="<?php echo $rw[2];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername3">contact</label>
                        <input type="number" class="form-control" id="exampleInputUsername3" placeholder="Contact" name="contact" value="<?php echo $rw[3];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername4">Password</label>
                        <input type="text" class="form-control" id="exampleInputUsername4" placeholder="Password" name="pass" value="<?php echo $rw[4];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername5">Confirm Password</label>
                        <input type="text" class="form-control" id="exampleInputUsername5" placeholder="Confirm Password" name="cpass" value="<?php echo $rw[5];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername6">Course name</label>
                        <input type="text" class="form-control" id="exampleInputUsername6" placeholder="Course Name" name="cname" value="<?php echo $rw[6];?>">
                      </div>
					 
					  <div class="form-group">
                        <label for="exampleInputUsername7">Gender</label>
                        <input type="text" class="form-control" id="exampleInputUsername7" placeholder="Gender" name="gender" value="<?php echo $rw[7];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername8">Image</label>
                        <input type="file" class="form-control" id="exampleInputUsername8" placeholder="" name="image" value="<?php echo $rw[8];?>">
                      </div>
                     <!-- <div class="form-group">

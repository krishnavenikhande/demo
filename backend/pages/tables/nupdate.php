...
if(isset($_POST['btn']))
{
    ...
    $update="update notification set date='$date' ,time='$time',title='$title',msg='$msg' where id=$id";
				  ...
				  ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputname1" placeholder="Enter Date" name="date" value="<?php echo $rw[1];?>">
                      </div>
					   
					  <div class="form-group">
                        <label for="exampleInputPassword1">Title</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Title" name="title" value="<?php echo $rw[2];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputPassword1">Message</label>
                        <input type="text" class="form-control" id="exampleInputCourseFile1" placeholder="Enter Message" name="msg" value="<?php echo $rw[3];?>" >
                      </div>
					 <!-- <div class="form-group">
                        <label for="exampleInputUsername1">Duration</label>
                        <input type="text" class="form-control" id="exampleInputDuration1" placeholder="Duration" name="duration" >
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername1">Fees</label>
                        <input type="number" class="form-control" id="exampleInputFees1" placeholder="Fees" name="fees">
                      </div>
                     <div class="form-group">

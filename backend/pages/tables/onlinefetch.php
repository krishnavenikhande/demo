      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
			...
			<li class="nav-item">
              <a class="nav-link" href="../../pages/tables/batchfetch.php">
                <span class="menu-title">Batch</span>
                <i class="mdi mdi-table-large menu-icon"></i>
              </a>
            </li>
			<li class="nav-item">
              <a class="nav-link" href="../../pages/tables/onlinefetch.php">
            ...
            <div class="row">
             <!-- <div class="col-lg-10 grid-margin stretch-card">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
				   <a href="../../pages/forms/online.php">
                      <button type="button" class="btn btn-gradient-primary me-2">Add Online Batch Details</button>
					  </a><br>
                    <h1 align="center" class="card-title">Batch Details</h1>
					...
					$res=mysqli_query($con,$sql);
					   ...
					   while($rw=mysqli_fetch_row($res))
                      {
                        ...
                        <tr>
                          ...
                          <td><?php echo $rw[6];?></td> 
						  <td><?php echo $rw[7];?></td> 
						  <td><a href="onlineupdate.php?id=<?php echo $rw[0];?>">Update</a></td>
						  <td><a href="onlinedelete.php?id=<?php echo $rw[0];?>">Delete</a></td>

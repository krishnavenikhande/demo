...
$totalfees=0;
$total="select sum(fees)from student where sid=$id";
$totalres=mysqli_query($con,$total);
$row=mysqli_fetch_row($totalres);
$totalfees=$row[0];

$paidquery="select sum(fees)from fees where sid=$id";
                ...
                <div class="card">
                  <div class="card-body">
				   <!--<a href="../../pages/forms/course.php">
                    ...
                    <h1 align="center" class="card-title">Student Fees Details</h1>
					...
					$name=$rw1[0];
					?>		
                     <p class="card-description"><code><?php echo $name;?></code>
                    </p>
					<p class="card-description"><code>Total Fees:<?php echo $totalfees;?>/-</code>
                    </p>
                     ...
                     <?php
                        ...
                        <tr>
						  ...
						  <td><?php echo $rw[3];?></td> 
					       ...
					       ?>
					      <tr>
						  <td colspan='3'>Total Paid Fees:</td>
						  <td><?php echo $total;?>/-</td>
						  </tr>
						  <tr>
						  <td colspan='3'>Available Balance:</td>

            ...
            <div class="row">
             <!-- <div class="col-lg-10 grid-margin stretch-card">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
				   <a href="../../pages/forms/batch.php">
                      <button type="button" class="btn btn-gradient-primary me-2">Add Batch Details</button>
					  </a><br>
                    <h1 align="center" class="card-title">Offline Batch Details</h1>
					...
					$res=mysqli_query($con,$sql);
					   ...
					   while($rw=mysqli_fetch_row($res))
                      {
                        ...
                        <tr>
                          ...
                          <td><?php echo $rw[6];?></td> 
						  <td><?php echo $rw[7];?></td> 
						  <td><a href="batchupdate.php?id=<?php echo $rw[0];?>">Update</a></td>
						  <td><a href="batchdelete.php?id=<?php echo $rw[0];?>">Delete</a></td>

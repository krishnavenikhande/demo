...
if(isset($_POST['btn']))
{
    ...
    $filename=$_FILES['image']['name'];
	    ...
	    $filestore="../forms/pic/".$filename;
		
			
			$pdfname=$_FILES['pdf']['name'];
			$pdfsize=$_FILES['pdf']['size'];
			$pdftemnm=$_FILES['pdf']['tmp_name'];
  ...
  if(move_uploaded_file($filetemnm,$filestore))
	{
		if(move_uploaded_file($pdftemnm,$pdfstore))
		{
    $update="update course set name='$name',image='$filename',cfile='$pdfname',duration='$duration',fees=$fees,courseid=$courseid where id=$id";
				  ...
				  ?>
                    ...
                    <form method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="your_summernote" placeholder="" name="description" ></textarea>
                      </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
                        <label for="exampleInputPassword1">Course File</label>
                        <input type="file" class="form-control" id="exampleInputCourseFile1" placeholder="" name="pdf" >
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername1">Duration</label>
                        <input type="text" class="form-control" id="exampleInputDuration1" placeholder="Duration" name="duration" value="<?php echo $rw[5];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername1">Fees</label>
                        <input type="text" class="form-control" id="exampleInputFees1" placeholder="Fees" name="fees" value="<?php echo $rw[6];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername2">Course ID</label>
                        <input type="text" class="form-control" id="exampleInputFees2" placeholder="Course Id" name="courseid" value="<?php echo $rw[7];?>">
                      </div>
                     <!-- <div class="form-group">

...
if(isset($_POST['btn']))
{
    ...
    $update="update batch set course='$course',faculty='$faculty',date='$date',time='$time',duration='$duration',
	fees='$fees',location='$location' where id=$id";
				  ...
				  ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Course" name="course" value="<?php echo $rw[1];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername2">Faculty</label>
                        <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Faculty" name="faculty" value="<?php echo $rw[2];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername3">Date</label>
                        <input type="text" class="form-control" id="exampleInputUsername3" placeholder="Date" name="date" value="<?php echo $rw[3];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername4">Time</label>
                        <input type="text" class="form-control" id="exampleInputUsername4" placeholder="Time" name="time" value="<?php echo $rw[4];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername5">Duration</label>
                        <input type="text" class="form-control" id="exampleInputUsername5" placeholder="Duration" name="duration" value="<?php echo $rw[5];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername6">Fees</label>
                        <input type="number" class="form-control" id="exampleInputUsername6" placeholder="Fees" name="fees" value="<?php echo $rw[6];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername7">Location</label>
                        <input type="text" class="form-control" id="exampleInputUsername7" placeholder="location" name="location" value="<?php echo $rw[7];?>">
                      </div>

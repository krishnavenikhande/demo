...
<html lang="en">
  ...
  <body>
		...
		if(move_uploaded_file($filetemnm,$filestore))
	{
		...
		$tb1="insert into details(name,description,duration,fees,image,file)values('$name','$description','$duration','$fees','$filename','$pdfname')";
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Top Courses</li>
                </ol>
              </nav>
            </div>
            <div class="row">
            <!--  <div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Top Course Details</h4>

    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
		...
		<?php
			...
			{
			$sid=$_POST['name'];
			$batchid=$_POST['course'];

	
		$tb1="insert into admission(sid,batchid)values($sid,$batchid)";
		...
		$tb2="update student set status='Active' where sid=$sid";
                  ...
                  <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                      <div>
						...
						<?php
						    $sql="select * from student inner join register on student.sid=register.id";
							$res=mysqli_query($con,$sql);
							while($rw=mysqli_fetch_row($res))
							{
						?>
						<option value="<?php echo $rw[1];?>"><?php echo $rw[8];?></option>
                        <?php
							}
                        ?>							
						</select>		
					   ...
					   <div>
                        <label for="exampleInputPassword4">Batch Name</label>
                        <select class="form-control" id="exampleInputPassword4" name="course">
						<option>Select course</option>
						<?php
						$sql1="select * from batch inner join course on batch.id=course.id";
						$res1=mysqli_query($con,$sql1);
						while($rw=mysqli_fetch_row($res1))
						{
						?>
						<option value="<?php echo $rw[8];?>"><?php echo $rw[9];?></option>
						<?php
						}
						?>
						</select>

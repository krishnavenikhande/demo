...
<html lang="en">
  ...
  <body>
	...
	{
		if(move_uploaded_file($pdftemnm,$pdfname))
		{
		$tb1="insert into course(name,description,image,cfile,duration,fees,courseid)values('$name','$description','$filename','$pdfname','$duration','$fees','$courseid')";
                  ...
                  <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="your_summernote" name="description"></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Image</label>
                        <input type="file" class="form-control" id="exampleInputPassword4" name="image">
                      </div>
					   <div class="form-group">
                        <label for="exampleInputPassword4">Course File</label>
                        <input type="file" class="form-control" id="exampleInputPassword4" name="pdf">
                      </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="exampleInputName1" placeholder="course id" name="courseid">
                      </div>
                     <!-- <div class="form-group">

...
if(isset($_POST['btn']))
{
	...
	$paidquery="select sum(fees) from fees where sid=$sid";
	$paidres=mysqli_query($con,$paidquery);
	$paidrow=mysqli_fetch_row($paidres);
	
	$paidfees=$paidrow[0]+$fees;
	
	$feesq="select sum(fees) from student where sid=$sid";
	$paidres1=mysqli_query($con,$feesq);
	$paidrow1=mysqli_fetch_row($paidres1);
	
	$totalfees=$paidrow1[0];
	if($paidfees>$totalfees)
	{
		echo "<script>alert('Check your balance')
		window.location.href='../tables/fees.php'
		</script>";
	}else{
		
	$sql="insert into fees(sid,payment_mode,fees,date)values($sid,'$payment_mode',$fees,'$date')";
           ...
           <!-- <div class="page-header">
            ...
            <!--  <div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Fees Entry</h4>
                    <p class="card-description"></p>
                    <form method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputName1">Student Name</label>
                        <select class="form-control" id="exampleInputName1" placeholder="Name" name="name">
						<option>Select Student Name</option>
						<?php
						    $sql="select * from register inner join student on register.id=student.sid";
							$res=mysqli_query($con,$sql);
							while($rw=mysqli_fetch_row($res))
							{
								?>
						<option value="<?php echo $rw[10];?>"><?php echo $rw[1];?></option>
						<?php	
							}
						?>	
							</select>						
					   ...
					   <div class="form-group">
                        <label for="exampleInputPassword4">Enter Amount</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="fees">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputPassword4">Date</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" placeholder="dd/mm/yyyy" name="date">
                      </div>
					 
					 <div class="form-group">
                        <label for="exampleInputName1">Payment Mode</label><br><br>
						<input type="radio" name="payment_mode" value="Cash ">&nbsp;Cash<br><br>
					    <input type="radio" name="payment_mode" value="Online ">&nbsp;Online<br><br>
					    <input type="radio" name="payment_mode" value="Cheque">&nbsp;Cheque<br>

                      </div>
					 <!-- <div class="form-group">
                        <label for="exampleInputName1">Fees</label>
                        <input type="number" class="form-control" id="exampleInputName1" placeholder="Fees"name="fees">
                      </div>

...
<html lang="en">
  ...
  <body>
		...
		if(move_uploaded_file($filetemnm,$filestore))
	{
		...
		{
		$tb1="insert into course(name,description,image,cfile,duration,fees)values('$name','$description','$filename','$pdfname','$duration','$fees')";
                    ...
                    <form method="post" enctype="multipart/form-data">
                      <div class="form-group">
					   ...
					   <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword4" name="">
                      </div>
					 <!-- <div class="form-group">

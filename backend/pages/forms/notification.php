    ...
    <div class="container-scroller">
     ...
     <?php
	  ...
	  ?>
		...
		$tb1="insert into notification(date,time,title,msg)values('$date','$time','$title','$msg')";
                  ...
                  <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Enter Date" name="date">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Time</label>
                        <input type="text" class="form-control" id="exampleInputName2"  name="time">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Title</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="title">
                      </div>
					   <div class="form-group">
                        <label for="exampleInputPassword4">Message</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="msg">
                      </div>
					  <!--<div class="form-group">

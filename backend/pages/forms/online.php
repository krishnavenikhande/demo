  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
			  ...
			  <!--<a class="nav-link" href="../../pages/forms/course.php">
		...
		$tb1="insert into online(course,faculty,date,time,duration,fees,location)values('$course','$faculty','$date','$time','$duration','$fees','$location')";
          ...
          <div class="content-wrapper">
            ...
            <!--  <div class="col-md-6 grid-margin stretch-card">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Online Batch Details</h4>
                    <p class="card-description"></p>
                    <form method="post">
                      <div class="form-group">
                        <label for="exampleInputName1">Course</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Course" name="course">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Faculty</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Faculty" name="faculty">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Date</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Date" name="date">
                      </div>
					   <div class="form-group">
                        <label for="exampleInputPassword4">Time</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Time" name="time">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputName1">Duration</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="duration" name="duration">
                      </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Location" name="location">
                      </div>

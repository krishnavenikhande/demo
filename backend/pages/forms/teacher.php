...
<html lang="en">
  ...
  <body>
	...
	{
		$tb1="insert into teacher(name,post,image)values('$name','$post','$filename')";
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Post</label>
                        <input type="text" class="form-control" id="exampleInputPost"  name="post">
                      </div>
                      <div class="form-group">

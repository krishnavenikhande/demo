  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
		...
		$tb1="insert into admin(username,email,pass,cpass)values('$username','$email','$pass','$cpass')";
                  ...
                  <div class="card-body">
                    ...
                    <form method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="exampleInputPost"  name="email">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Password</label>
                        <input type="password" class="form-control" id="exampleInputPassword4" name="pass">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputPassword4">Confirm Password</label>
                        <input type="password" class="form-control" id="exampleInputPassword4" name="cpass">
                      </div>
                     <!-- <div class="form-group">

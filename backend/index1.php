        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
		  ...
		  if(isset($_SESSION['admin']))
		  {
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                ...
                <i class="mdi mdi-account me-2 text-success"></i> Log out</a>
				  </div>
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
			    ...
			    <i class="mdi mdi-cached me-2 text-success"></i>User Dashboard</a>
			...
			<li class="nav-item ">
              <a class="nav-link" href="#" >
                ...
                <i class="mdi mdi-gmail" style='color:orange;'></i>
							 ...
							 <p class="mb-1 text-black">echo $_SESSION['email'];?></p>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-12 pe-1">
                        <img src="../img/c1.png" class="mb-2 mw-100 w-100 rounded" alt="image">

...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
							...
							<div class="nav-item dropdown">
                                <a href="Topcourses.php" class="nav-link dropdown-toggle active" data-toggle="dropdown">Top Courses</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="webdevelop.php" class="dropdown-item">Web Development</a>
                                    <a href="webdesign.php" class="dropdown-item active">Web Design</a>
									<a href="software.php" class="dropdown-item active">Software Testing</a>

                                </div>
                            </div>
							<div class="nav-item dropdown">
                                <a href="Topcourses.php" class="nav-link dropdown-toggle active" data-toggle="dropdown">All Batches</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <!--<a href="offline.php" class="dropdown-item active">Offline Batch</a>
                                    <a href="online.php" class="dropdown-item active">Online Batch</a>-->			
									<a href="internship.php" class="dropdown-item active">Internship Batch</a>
   ...
   <div class="carousel-inner">
        <div class="carousel-item active">
		  <img class="position-relative w-100" src="img/h44.jpg" style="min-height: 100px; object-fit: cover;">
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <h2 class="text-primary mb-3">Web Design</h2>
                        <h1 class="mb-5"></h1>
                        <img class="img-fluid rounded mb-4" src="img/h15.jpg" style='width:600px;' alt="Image">
                        <p>Web Designing courses consist of different skills, disciplines in the production and 
						maintenance of websites. Most of us take different professional courses when it comes to 
						taking up a course in college. And many of those colleges provide you with opportunities 
						for placement wherein you will be placed in a well-reputed company of your choice.One such 
						course which has huge placement opportunities in the course of web designing.By learning 
						the course of web designing the candidate gets the opportunity to learn about the different 
						areas that come under this course like web graphic design, interface design, standardized code
						and proprietary software user experience design and SEO.With an increase in startups and other
						business establishments, web designing has become a more common process to boost their business. 
						And well-qualified candidates in Web designing courses can help the companies build their reputation 
						and also have a bright career for themselves.There are different ways you can pursue this course. 
						The candidate can take up bachelors in web designing and then pursue their masters, or they can take 
						up a diploma in web designing and then do a post-graduate diploma in the same. The duration of the 
						course when you take up bachelors is three years and for masters its three years. If you are taking 
						up a diploma, then the duration is one year.</p>

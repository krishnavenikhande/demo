...
if(isset($_POST['btn2']))
{
	...
	$t1="select id from register where email='$Email'";
	$res1=mysqli_query($con,$t1);
	$ct=mysqli_fetch_row($res1);
	$id=$ct[0];
	
	$t2="select count(id) from onlinestudent where sid=$id and course='$course'";
	$res=mysqli_query($con,$t2);
	...
	{
		$t3="insert into onlinestudent(sid,course,duration,fees)values($id,'$course','$duration',$fees)";
...
<body>
                        ...
                        <div class="navbar-nav py-0">
							...
							<div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="single.php" class="dropdown-item active">Web Development</a>
	...
	<div class="container-fluid " style="margin-bottom: 90px;">
	 <!--<img class="position-relative w-100" src="img/b1.png" style="object-fit: cover;">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <!--<div class="mb-5">
                        ...
                        <h1 class="mb-5"></h1>
                        <img class="img-fluid rounded mb-4" src="img/web1.jpg" style='width:600px;' alt="Image">
 ...
 and be fully prepared to take the next step in a more advanced web development or design course or specialization.</p>
                    ...
                    <!--<div class="bg-secondary rounded p-5" style='text-align:center;'>
                        ...
                        <ul class="list-group list-group-flush" style='text-align:center;'>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="course.php? class="text-decoration-none h6 m-0">HTML</a>
                                <span class="badge badge-primary badge-pill"></span>
                            </li><br>
							
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="course.php class="text-decoration-none h6 m-0">CSS</a>
                                <span class="badge badge-primary badge-pill"></span>
                            </li><br>

                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="course.php class="text-decoration-none h6 m-0" >JAVA Script</a>
                                <span class="badge badge-primary badge-pill"></span>
                            </li><br>
							
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="course.php class="text-decoration-none h6 m-0">PHP</a>
                                <span class="badge badge-primary badge-pill"></span>
                            </li><br>
							<li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <a href="course.php class="text-decoration-none h6 m-0">JQuery</a>
                                <span class="badge badge-primary badge-pill"></span>
                            </li>
                ...
                <div class="col-lg-12 mt-5 mt-lg-0">
                   ...
                   <!-- <div class="mb-5">
                    ...
                    <!-- Category List -->
                    <div class="mb-5">
                        <h3 class="text-uppercase mb-4" style="letter-spacing:3px;">Online Batches</h3>
						...
						?>
						 ...
						 <tr>
						  ...
						  <td><?php echo $rw[7];?></td> 
						  <form method="post">
						  <input type="hidden" name="course" value="<?php echo $rw[2];?>">
							<input type="hidden" name="duration" value="<?php echo $rw[5];?>">
							<input type="hidden" name="fees" value="<?php echo $rw[6];?>">
						  
						  
						  <td><button class="btn btn-primary py-1 px-2 ml-auto d-none d-lg-block" name="btn">Join</button></td>
		                 </tr>
						 </form>
						   <?php
					       }

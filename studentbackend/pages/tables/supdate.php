...
if(isset($_POST['btn']))
{
    ...
    $update="update student set course='$course',duration='$duration',fees='$fees' where id=$id";
				  ...
				  ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputname1" placeholder="Course" name="course" value="<?php echo $rw[2];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputPassword1">Duration</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Duration" name="duration" value="<?php echo $rw[3];?>">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputPassword1">Fees</label>
                        <input type="text" class="form-control" id="exampleInputCourseFile1" placeholder="Fees" name="fees" value="<?php echo $rw[4];?>">
                      </div>
					 <!-- <div class="form-group">
                        <label for="exampleInputUsername1">Duration</label>
                        <input type="text" class="form-control" id="exampleInputDuration1" placeholder="Duration" name="duration" value="">
                      </div>
					  <div class="form-group">
                        <label for="exampleInputUsername1">Fees</label>
                        <input type="number" class="form-control" id="exampleInputFees1" placeholder="Fees" name="fees" value="">
                      </div>-->
                     <!-- <div class="form-group">

    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
		...
		<h2><a class="navbar-brand brand-logo" href="index.php">
		 <img src="logo.jpg" style='height:40px;width:40px;'><font style='font-size:25px;'>GayatriInfo</font>
          </a></h2>
         <!--<h2> <a class="navbar-brand brand-logo" href="../../index.php"><img src="../../assets/images/L1.png" style='height:50px; width:50px;'alt="logo" />Gayatri Info</a></h2>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
			 ...
			 <li class="nav-item">
              <a class="nav-link" href="../../pages/forms/teacher.php">
                <span class="menu-title">Staff Details</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>-->
			   <li class="nav-item">
             <!-- <a class="nav-link" href="../../pages/forms/delete.php">
                <span class="menu-title">Course Delete</span>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>-->
            </li>
            <!--<li class="nav-item">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                     <!-- <div class="form-group">
					  ...
					  <a href="../../pages/forms/teacher.php">
                      <button type="button" class="btn btn-gradient-primary me-2">Add Teacher Details </button>
					  </a>-->
